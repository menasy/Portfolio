...
% Summary
I focus on continuously improving myself in software development, web technologies, DevOps, and especially mobile programming. During this process, I have developed various projects using C, C++, JavaScript, and Java. I have created Android-based applications. I have set up microservice architectures using Docker and container technologies. Using C++ for socket programming, my teammate and I developed a web server using the HTTP/1.1 protocol and a classic Pong game from scratch using modern technologies. You can check out all the details of these projects, my \textbf{\href{https://medium.com/@menasy}{Medium}} articles, and my \textbf{\href{https://menasy.com.tr/}{portfolio}} for my other works.
\vspace{-0.4em}
