...
const LanguageItem = ({ src, alt, label, level }) => {
  ...
  return (
    <div className="group relative">
      ...
      <div className="relative group/skill flex items-center gap-3 p-3 rounded-lg bg-white/95 dark:bg-slate-700/95 backdrop-blur-sm border border-emerald-200/50 dark:border-emerald-600/50 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
