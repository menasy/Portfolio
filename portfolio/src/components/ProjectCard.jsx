				...
				{(features || technologies) && (
							...
							{features && (
								<div className="space-y-2">
									<div className="flex items-center gap-1.5">
										<div className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-emerald-500 to-cyan-500"></div>
										<h4 className="text-xs font-semibold text-slate-900 dark:text-white uppercase tracking-wide">Özellikler</h4>
									</div>
									<ul className="space-y-1.5">
										{features.map((f, idx) => (
											<li key={idx} className="group/feature flex items-start gap-2 p-1 rounded hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors duration-200">
												<div className="flex-shrink-0 w-4 h-4 rounded-full bg-gradient-to-br from-emerald-500 to-cyan-500 flex items-center justify-center mt-0.5 group-hover/feature:scale-110 transition-transform duration-200">
							...
							{technologies && (
								<div className="space-y-2">
									<div className="flex items-center gap-1.5">
										...
										<h4 className="text-xs font-semibold text-slate-900 dark:text-white uppercase tracking-wide">Teknolojiler</h4>
									</div>
					...
					<div className="pt-1.5 sm:pt-2 flex justify-end">
						<a
							...
							target="_blank"
							rel="noreferrer"
							className="group/action inline-flex items-center gap-1.5 text-xs sm:text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors duration-200"
						>
							<span>Projeye Git</span>
							<svg className="w-3.5 h-3.5 group-hover/action:translate-x-0.5 group-hover/action:-translate-y-0.5 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
							</svg>
						</a>
					</div>
