...
export default function BlogSection() {
	return (
		<section id="blog-yazilari" className="space-y-4 sm:space-y-5 max-w-6xl mx-auto px-4">
			...
			<RevealOnScroll animation="slide-rotate" delay={0}>
					...
					<div className="relative p-5 sm:p-6 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-green-200/50 dark:border-green-700/50 shadow-lg group-hover:shadow-xl group-hover:-translate-y-1.5 transition-all duration-500 h-full flex flex-col">
						<div className="flex items-start gap-3 mb-4">
							...
							<div className="flex-1">
								<h3 className="font-bold text-slate-900 dark:text-white text-lg sm:text-xl leading-tight mb-2">C++ Modülleri ve C++ Temelleri</h3>
								<div className="flex flex-wrap gap-1.5">
									{['C++', 'OOP', '42 School', 'Memory Management'].map(t => (
										<span key={t} className="px-2.5 py-1 rounded-full bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs font-medium">{t}</span>
									))}
								</div>
							</div>
						</div>
						...
						<a href="https://medium.com/@menasy/list/42-cpp-modulleri-ve-c-temelleri-710fabe3b608" target="_blank" rel="noreferrer"
							className="inline-flex items-center gap-1.5 text-sm sm:text-base text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-semibold group-hover:underline mt-auto">
							Yazı Serisini Oku
				...
				<div className="group relative h-full">
					<div className="relative p-5 sm:p-6 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-blue-200/50 dark:border-blue-700/50 shadow-lg group-hover:shadow-xl group-hover:-translate-y-1.5 transition-all duration-500 h-full flex flex-col">
						<div className="flex items-start gap-3 mb-4">
							...
							<div className="flex-1">
								<h3 className="font-bold text-slate-900 dark:text-white text-lg sm:text-xl leading-tight mb-2">Docker — 42 Inception Projesi</h3>
								<div className="flex flex-wrap gap-1.5">
									{['Docker', 'DevOps', 'Microservices', '42 School'].map(t => (
										<span key={t} className="px-2.5 py-1 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-medium">{t}</span>
									))}
								</div>
							</div>
						</div>
						...
						<a href="https://medium.com/@menasy/docker-42-inception-projesi-484e48ae543c" target="_blank" rel="noreferrer"
							className="inline-flex items-center gap-1.5 text-sm sm:text-base text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold group-hover:underline mt-auto">
							Yazıyı Oku
							<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
							</svg>
				...
				<div className="group relative h-full">
					<div className="relative p-5 sm:p-6 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-purple-200/50 dark:border-purple-700/50 shadow-lg group-hover:shadow-xl group-hover:-translate-y-1.5 transition-all duration-500 h-full flex flex-col">
						<div className="flex items-start gap-3 mb-4">
							...
							<div className="flex-1">
								<h3 className="font-bold text-slate-900 dark:text-white text-lg sm:text-xl leading-tight mb-2">BlockChain Teknolojisi ve Kur'an-ı Kerim'in Muhafaza Sistemi</h3>
								<div className="flex flex-wrap gap-1.5">
									{['Blockchain', 'Web3', 'Analysis', 'İslam'].map(t => (
										<span key={t} className="px-2.5 py-1 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-medium">{t}</span>
									))}
								</div>
							</div>
						</div>
						...
						<a href="https://medium.com/@menasy/blockchain-teknolojisi-ve-kuran-%C4%B1-kerim-in-korunmas%C4%B1-77c6c04726b8" target="_blank" rel="noreferrer"
							className="inline-flex items-center gap-1.5 text-sm sm:text-base text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-semibold group-hover:underline mt-auto">
							Yazıyı Oku
							<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
							</svg>
				...
				<div className="relative p-5 sm:p-6 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-slate-200/50 dark:border-slate-700/50 shadow-lg group-hover:shadow-xl group-hover:-translate-y-1.5 transition-all duration-500 h-full flex flex-col">
						<div className="flex items-start gap-3 mb-4">
							...
							<div className="flex-1">
								<h3 className="font-bold text-slate-900 dark:text-white text-lg sm:text-xl leading-tight mb-2">Tüm Blog Yazılarım</h3>
								<div className="flex flex-wrap gap-1.5">
									{['All Posts', 'Technology', 'Knowledge Sharing'].map(t => (
										<span key={t} className="px-2.5 py-1 rounded-full bg-slate-100 dark:bg-slate-700/60 text-slate-700 dark:text-slate-300 text-xs font-medium">{t}</span>
									))}
								</div>
							</div>
						</div>
						...
						<a href="https://medium.com/@menasy" target="_blank" rel="noreferrer"
							className="inline-flex items-center gap-1.5 text-sm sm:text-base text-slate-600 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 font-semibold group-hover:underline mt-auto">
