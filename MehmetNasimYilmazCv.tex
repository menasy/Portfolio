...
% Özet
Yazılım geliştirme; web teknolojileri, DevOps ve mobil programlama alanlarında kendimi sürekli geliştirmeye odaklanıyorum. Bu süreçte; android tabanlı uygulamalar yaptım. Docker kullanarak mikro servis mimarileri kurdum. Wowza Streaming Engine,  .NET tabanlı backend ve React tabanlı frontend kullanarak full-stack bir canlı yayın platformu geliştirdim. C++ ile soket programlama yaparak, ekip arkadaşım ile sıfırdan; HTTP/1.1 protokolünü kullanan bir web sunucusu yaptık. Klsik Pong oyununu modern teknolojilerle sıfırdan grliştirdik. Tüm bu projelerle ilgili detaylara, \textbf{\href{https://medium.com/@menasy}{Medium}} yazılarıma ve diğer çalışmalarımı içeren  \textbf{\href{https://menasy.com.tr/}{portföyüme}} göz atabilirsiniz.
\vspace{-0.5em}
...
\vspace{-0.2em}
\begin{itemize}[leftmargin=2em]
 \item Baykar Teknoloji – Merkezi Kontrol Yazılımları Stajyeri / 06.10.2025 - Devam ediyor
